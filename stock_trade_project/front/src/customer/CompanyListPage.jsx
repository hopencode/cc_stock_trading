...
function CompanyListPage() {
  ...
  const isValidCompany = (name) => companies.some(c => c.name === capitalize(name));
  ...
  const handleGoFinance = () => {
    ...
    setAlert("");
    navigate(`/customer/finance?name=${encodeURIComponent(capitalize(inputName))}`);
  };
  ...
  const handleGoOrderbook = () => {
    ...
    setAlert("");
    navigate(`/customer/order?name=${encodeURIComponent(capitalize(inputName))}`);
  };
